...
public class Manifest
    {
        ...
        public static Manifest GetManifest(bool forceLoad = false)
        {
            ...
            if (!System.IO.Directory.Exists(maDir))
            {
            ...
            {
                MessageBox.Show("ManifestParseException");
            ...
            if (scanDir)
            {
                ...
                if (System.IO.Directory.Exists(maDir))
                {
                    ...
                    foreach (var file in files)
                    {
                        ...
                        {
                            Msg.ShowError("MaFileEncryptedException" +ex);
                        }
                    }
        ...
        public bool Save()
        {
            ...
            if (!System.IO.Directory.Exists(maDir))
            {
                try
                {
                    System.IO.Directory.CreateDirectory(maDir);
                }
                catch (Exception)
                {
                    return false;
